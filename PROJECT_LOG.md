...
| 2026-09-05 | v1.11.1 patch acceptance | 311 tests and Ruff passed; skill/plugin validators passed. Clean-archive install used a fresh runtime; partial Codex uninstall with RemoveRuntime preserved Claude, whose installed launcher passed live doctor. Isolated legacy installer test fixtures from real host directories and gave the hanging-tool timeout test sufficient process startup time. |
